...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO entradas (user_id, tipo_entrada, monto, fecha, nombre_archivo) VALUES (:user_id, :tipo_entrada, :monto, :fecha, :nombre_archivo)");

        $file = "facturas/" . $file;

        // Bind parameters
        $stmt->bindParam(':user_id', $_SESSION['user_id'], PDO::PARAM_INT);
        $stmt->bindParam(':tipo_entrada', $_POST["tipo_entrada"], PDO::PARAM_STR);
