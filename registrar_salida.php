...
<main class="bg-gray-100 min-h-screen flex items-center justify-center flex-col gap-4">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        <form action="./controllers/procesar_salida.php" method="POST" enctype="multipart/form-data">
            <!-- Tipo de Salida -->
            <div class="mb-4">
                <label for="tipo_salida" class="block text-gray-700 font-bold mb-2">Tipo de Salida:</label>
                <input type="text" name="tipo_salida" placeholder="Salario septiembre" id="tipo_salida" class="border rounded-lg px-3 py-2 w-full focus:outline-none focus:border-blue-500">
            </div>
            ...
            <!-- Fecha -->
            <div class="mb-4">
                <label for="fecha" class="block text-gray-700 font-bold mb-2">Fecha de salida:</label>
